package com.joel.yupicturebackend.controller;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.joel.yupicturebackend.annotation.AuthCheck;
...
import com.joel.yupicturebackend.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.joel.yupicturebackend.api.imagesearch.ImageSearchApiFacade;
import com.joel.yupicturebackend.api.imagesearch.model.ImageSearchResult;
import com.joel.yupicturebackend.common.BaseResponse;
import com.joel.yupicturebackend.common.DeleteRequest;
import com.joel.yupicturebackend.common.ResultUtils;
import com.joel.yupicturebackend.constants.UserConstant;
...
import com.joel.yupicturebackend.model.vo.PictureTagCategory;
...
public class PictureController {
    ...
    public BaseResponse<PictureTagCategory> listPictureTagCategory() {
        ...
        List<String> tagList = Arrays.asList(
                // 主题类
                "自然风光", "城市建筑", "人物肖像", "动物宠物", "美食佳肴", "科技数码", "时尚潮流", "节日庆典",
                // 风格类
                "写实", "抽象", "复古", "现代", "卡通", "简约", "华丽",
                // 画质类
                "高清", "全景", "特写");
        List<String> categoryList = Arrays.asList( "背景", "封面", "头像", "海报", "宣传", "简历", "壁纸", "素材", "表情包");
