package com.joel.yupicturebackend.service.impl;
...
import com.joel.yupicturebackend.api.aliyunai.AliYunAiApi;
...
import com.joel.yupicturebackend.manager.upload.FilePictureUpload;
import com.joel.yupicturebackend.manager.upload.PictureUploadTemplate;
import com.joel.yupicturebackend.manager.upload.UrlPictureUpload;
...
import com.joel.yupicturebackend.model.enums.PictureReviewStatusEnum;
import com.joel.yupicturebackend.model.vo.PictureVO;
import com.joel.yupicturebackend.model.vo.UserVO;
import com.joel.yupicturebackend.service.PictureService;
import com.joel.yupicturebackend.mapper.PictureMapper;
import com.joel.yupicturebackend.service.SpaceService;
import com.joel.yupicturebackend.service.UserService;
import com.joel.yupicturebackend.utils.ColorSimilarUtils;
import com.joel.yupicturebackend.utils.HexColorExpanderUtils;
...
//        picture.setPicColor(uploadPictureResult.getPicColor());
        // 补全缺失的 RGB 十六进制码
        picture.setPicColor(HexColorExpanderUtils.expandHexColor(uploadPictureResult.getPicColor()));
     ...
     *
     * @param pictureQueryRequest 图片请求查询条件
     * @return QueryWrapper
     */
    @Override
    ...
    public List<PictureVO> searchPictureByColor(Long spaceId, String picColor, User loginUser) {
        // 1. 校验参数
        ThrowUtils.throwIf(spaceId == null || picColor == null || picColor.isEmpty(), ErrorCode.PARAMS_ERROR);
        ThrowUtils.throwIf(loginUser == null, ErrorCode.NO_AUTH_ERROR);
        // 2. 校验空间权限
        Space space = spaceService.getById(spaceId);
        ThrowUtils.throwIf(space == null, ErrorCode.NOT_FOUND_ERROR, "空间不存在");
