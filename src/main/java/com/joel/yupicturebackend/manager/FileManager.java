...
import com.joel.yupicturebackend.model.enums.ImageFormatEnum;
...
public class FileManager {
    ...
    public void validPicture(MultipartFile multipartFile) {
        ...
        ThrowUtils.throwIf(!ImageFormatEnum.getAllowedSuffixes().contains(fileSuffix), ErrorCode.PARAMS_ERROR, "文件类型错误");
    }
